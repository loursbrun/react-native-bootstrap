                ...
                <View style={[styles.content]}>
                    <View style={[styles.analytics]}>
                        <View style={[styles.item]}>
                            <Button onClick={() => {
                                trackEvent('Test Event', {
                                    'description': 'Test Event by Cityscan Firebase'
                                })
                        ...
                        <View style={[styles.item]}>
                            <Button onClick={() => {
                                recordScreenTransition('Analytics Screen', {
                                    'description': 'Analytics Screen transition by Cityscan Firebase'
                                })
                        ...
                        <View style={[styles.message]}>
                            ...
                            <Text style={[styles.info]}>Email : testing@cityscan.fr</Text>
                            <Text style={[styles.info]}>Password : Cityscan@123</Text>
                        </View>
                    </View>
                </View>
            </ScrollView>
