                ...
                <View>
                    ...
                    <View style={[styles.social]}>
                        ...
                        <Link onPress = {()=>{this.setState({githubSignIn : true})}}  >
                            <Icon name={'github-square'} style={[styles.githubIcon]} style={{height: 0, width: 0}}/>
                        </Link>
...
/* 
<Text style={[styles.separatorOr]} style={{height: 0, width: 0, backgroundColor: 'green'}}>OR</Text>
                    <Button style={styles.button} onClick={this.togglePhoneSignIn.bind(this)} style={{height: 0, width: 0, backgroundColor: 'green'}}>
